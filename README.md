...
## 4. Front-End Basics
  HTML is the language which tell the browzer how it should to display site or app. CSS helps HTML and make site or app perfect with help of more specialied features.
